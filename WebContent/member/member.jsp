...
<body>
	...
	if (name == null || ssn1 == null || ssn2 == null || name.trim().equals("") || ssn1.trim().equals("")
			|| ssn2.trim().equals("")) {
	...
	<form name="f" method="POST" action="member_input.jsp">
		<table width="600" align="center" class="outline">
			...
			<tr>
				...
				<td class="m3"><input type="text" name="name" class="box" value="<%=name%>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="m3"><input type="text" name="ssn1" class="box" maxlength="6" value="<%=ssn1%>"> - 
					<input type="text" name="ssn2" class="box" maxlength="7" value="<%=ssn2%>"></td>
			</tr>
			<tr>
